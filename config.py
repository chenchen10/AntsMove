...
# 区域配置（方案C：左×1.8/中×1.0/右×2.0）
ZONE_CONFIG = {
    'left':   {'x_range': (0, 1399),    'y_range': (0, 850), 'multiplier': 1.8, 'refresh_interval': 8, 'spawn_prob': 0.30},
...
CREATURE_COLORS = {
    ...
    'cricket': (160, 120, 60),     # 棕色蟋蟀
    'caterpillar': (60, 160, 60),  # 深绿色毛毛虫
    'beetle': (80, 50, 100),       # 深紫色甲虫
    'dragonfly': (60, 140, 220),   # 蓝色蜻蜓
    'bee': (230, 190, 40),         # 黄色蜜蜂
}
